...
2. Relocate the vector table at address 0x08003000. To perform this operation,copy the vector
table from the Flash (mapped at the base of the application load address 0x08003000) to the base 
address of the SRAM at 0x20000000.
 
The SysTick example provided within the STM32F0xx Standard Peripheral examples is used as illustration.   
...
@par Directory contents
  ...
  + binary_template\inc: contains the binary_template firmware header files 
    - stm32f0x_conf.h    Library Configuration file for STM32F0xxx devices
  ...
  + binary_template\src: contains the binary_template firmware source files 
    - main.c              Main program
    - stm32_it.c      	  Interrupt handlers for STM32F0x device
...
@par Hardware environment
   ...
   - Use LD1, LD2, LD3 and LD4 leds connected respectively to PD.08, PD.09, PD.10
      and PD.11 
